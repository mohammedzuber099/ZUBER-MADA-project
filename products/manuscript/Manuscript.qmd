...
Endometrial cancer, a neoplasm originating from the endometrial lining, is the most common gynecological cancer in the United States.[@Monk2022] According to American Cancer Society 2024 statistics the incidence of uterine cancer is 67, 880 with 13,250 deaths. Due to its early symptomatic presentation, 70% of cases are diagnosed at stage I, where the five-year survival rate exceeds 90%. However, around 13% of patients are diagnosed at advanced stages (III/IV).
